...
var missile = preload("res://battlefield/missiles/cannonball.tscn")
...
func attack():
	$AnimationPlayer.play("Shooter_Attack")
...
func _on_animation_player_animation_finished(anim_name):
	if anim_name == "Shooter_Attack":
		current_state = STATE.WAITING
		$AnimationPlayer.play("Siege_Wait")
	if anim_name == "Siege_Wait":
		check_attack()
